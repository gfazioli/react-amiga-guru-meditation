...
const TABS = [
  { id: "npm", label: "npm", cmd: "npm install react-amiga-guru-meditation" },
  { id: "pnpm", label: "pnpm", cmd: "pnpm add react-amiga-guru-meditation" },
  { id: "yarn", label: "yarn", cmd: "yarn add react-amiga-guru-meditation" },
] as const;

const USAGE = `import { AmigaErrorBoundary } from "react-amiga-guru-meditation";
        ...
        <div className="install-grid">
          ...
          <div className="install-card">
            <div className="install-tabs">
              <span className="install-tab-static">App.tsx</span>
